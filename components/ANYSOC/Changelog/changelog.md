...
[▶️ Update from an older version of Surface Duo UEFI and Drivers (both got updated with v2401.90)](https://github.com/WOA-Project/SurfaceDuo-Guides/blob/main/Update/UpdateDriversAndUEFI.md)
