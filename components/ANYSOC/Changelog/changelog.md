## Surface Duo Drivers BSP - Version 2408.XX (Ornithoptera alexandrae)
...
<details>
  ...
  <p>
- ⚠️ This version of the drivers needs to be paired with UEFI version greater than or equal to 2408.XX.
...
- Please download ```SurfaceDuo-Drivers-v2408.XX-Desktop-Epsilon.zip``` if you want drivers for Surface Duo 1

- Please download ```SurfaceDuo-Drivers-v2408.XX-Desktop-Zeta.zip``` if you want drivers for Surface Duo 2
