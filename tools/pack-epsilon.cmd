...
echo components\QC8150\Device\DEVICE.SOC_QC8150.EPSILON >> filelist_epsilon.txt
echo components\QC8150\Device\DEVICE.SOC_QC8150.EPSILON_MINIMAL >> filelist_epsilon.txt
echo components\QC8150\Graphics\GRAPHICS.SOC_QC8150.EPSILON_DESKTOP_WDDM26 >> filelist_epsilon.txt
echo components\QC8150\Platform\PLATFORM.SOC_QC8150.BASE >> filelist_epsilon.txt
echo components\QC8150\Platform\PLATFORM.SOC_QC8150.BASE_MINIMAL >> filelist_epsilon.txt
echo definitions\Desktop\ARM64\Internal\epsilon_ti.txt >> filelist_epsilon.txt
echo definitions\Desktop\ARM64\PE\epsilon.txt >> filelist_epsilon.txt
echo LICENSE.md >> filelist_epsilon.txt
echo README.md >> filelist_epsilon.txt

cd ..
"%ProgramFiles%\7-zip\7z.exe" a -tzip ..\SurfaceDuo-Drivers-Release\SurfaceDuo-Drivers-Desktop-Epsilon-TI.zip @tools\filelist_epsilon.txt -scsWIN
cd tools
...
echo components\QC8150\Device\DEVICE.SOC_QC8150.EPSILON >> filelist_epsilon.txt
echo components\QC8150\Device\DEVICE.SOC_QC8150.EPSILON_MINIMAL >> filelist_epsilon.txt
echo components\QC8150\Graphics\GRAPHICS.SOC_QC8150.EPSILON_DESKTOP_WDDM25 >> filelist_epsilon.txt
echo components\QC8150\Platform\PLATFORM.SOC_QC8150.BASE >> filelist_epsilon.txt
echo components\QC8150\Platform\PLATFORM.SOC_QC8150.BASE_MINIMAL >> filelist_epsilon.txt
echo definitions\Desktop\ARM64\Internal\epsilon_rs5.txt >> filelist_epsilon.txt
echo definitions\Desktop\ARM64\PE\epsilon.txt >> filelist_epsilon.txt
echo LICENSE.md >> filelist_epsilon.txt
echo README.md >> filelist_epsilon.txt

cd ..
"%ProgramFiles%\7-zip\7z.exe" a -tzip ..\SurfaceDuo-Drivers-Release\SurfaceDuo-Drivers-Desktop-Epsilon-RS5.zip @tools\filelist_epsilon.txt -scsWIN
cd tools
